    ...
    render() {
        return (
            <div>
                ...
                <Singleproduct key="1" name="VENENO SUPER CAR" price="$66.99" images="/img/product/single-product-1.jpg" description="The car has 1 12V / 7AH battery, 2 motors, super durable wheel. Built-in MP3 player, speed 3-6km / h, 2 modes of self-driving or remote control" 
